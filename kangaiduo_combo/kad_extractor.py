...
class CommExtractor:
    # 获取单品价格
    detail_singleprice = r'''(?:salePrice\s+:\s+)(?P<sSinglePrice>\d+|\d+.\d+)(?:,//)'''

    # 获取康爱多官方的内部的产品编号, 用于AJAX
    ...
    # 疗程装信息块
    detail_treatment_info = r'''(?:"ProductNum":)(?P<sProductNum>\d+)(?:.*?PrmPrice":)(?P<sPrmPrice>[\d\.]+)'''
