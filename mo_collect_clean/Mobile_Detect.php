...
class Mobile_Detect
{
    ...
    protected static $phoneDevices = array(
        ...
        'BlackBerry'    => 'BlackBerry|\bBB10\b|rim[0-9]+|\sZ10\s',
        ...
        'Sony'          => 'SonyST|SonyLT|SonyEricsson|SonyEricssonLT15iv|LT18i|E10i|LT28h|LT26w|SonyEricssonMT27i|S39h',
       ...
       'iMobile'        => 'i-mobile (IQ|i-STYLE|idea|ZAA|Hitz)',
		...
		'vivo'          => 'vivo|A11',
		'ZTE'           => 'ZTE',
		'HUAWEI'        => 'HUAWEI|HONOR|H60-L01|H60-L11|Che1-CL10|Che1-CL20',
		'XiaoMi'        => 'XiaoMi|HM\sNOTE|Redmi|MI\s[0-9]|m2\snote|HM\s1|\s2013022\s|Mi-4c|\sm2\s|\sM3S\s',
		'Letv'          => 'Letv|X608',
		'OPPO'          => 'OPPO|R811|R8207|N5117|R7007|R7Plusm|A31c|R821T|\s3007\s|\s6607\s|R7c',
		'qiku'          => '8681-A01',
		'Hisense'       => 'HS-Hisense|HS-E820',
		'Coolpad'       => 'Coolpad',
		'TCL'           => 'TCL',
		'DOOV'          => 'DOOV',
		'GiONEE'        => 'GiONEE|V185|GN151|V182',
		'Lingwin'       => 'Lingwin'
	);
	...
	protected static $operatingSystems_m = array(
        'AndroidOS'         => 'Android',
        'BlackBerryOS'      => 'blackberry|\bBB10\b|rim tablet os',
        'PalmOS'            => 'PalmOS|avantgo|blazer|elaine|hiptop|palm|plucker|xiino',
        'SymbianOS'         => 'Symbian|SymbOS|Series60|Series40|SYB-[0-9]+|\bS60\b',
    ...
    protected static $browsers = array(
        ...
        'Skyfire'         => 'Skyfire',
        'IEmobile'        => 'IEMobile|MSIEMobile', // |Trident/[.0-9]+
     ...
     protected static $browsers_m = array(
        // @reference: https://developers.google.com/chrome/mobile/docs/user-agent
        'Chrome'          => '\bCrMo\b|CriOS|Android.*Chrome/[.0-9]* (Mobile)?',
        'Dolfin'          => '\bDolfin\b',
        'Opera'           => 'Opera.*Mini|Opera.*Mobi|Android.*Opera|Mobile.*OPR/[0-9.]+|Coast/[0-9.]+',
    ...
    protected static $properties = array(
		...
		'hao123'       => 'hao123/[VER]',
		'Mb2345Browser'=>'Mb2345Browser/[VER]',
        'MQQBrowser'    => 'MQQBrowser/[VER]',
		'QQBrowser'    =>  'QQBrowser/[VER]',
		'2345Explorer' =>   '2345Explorer/[VER]',
		'LBBROWSER'    =>   'LBBROWSER',
		'SE 2.X MetaSr'=>   'SE 2.X MetaSr [VER]',
		'360SE'        =>  '360SE',
		 'Maxthon'    =>   'Maxthon/[VER]',
    ...
    */
	...
	public static function getAllDetectionRules()
    {
        static $rules;
	...
	public function getRules1()
    {
        if ($this->detectionType == self::DETECTION_TYPE_EXTENDED) {
            ...
            return self::getAllDetectionRules();
        }
    }
    ...
    */
    protected function matchUAAgainstKey($key, $userAgent = null)
    {
        ...
        $_rules = array_change_key_case($this->getRules1());
    ...
    */
    ...
    public function mobileGrade()
    {
        ...
        if (
            ...
            ( ($this->is('UCBrowser') || $this->is('Dolfin')) && $this->version('Android', self::VERSION_TYPE_FLOAT)>=2.3 ) ||
